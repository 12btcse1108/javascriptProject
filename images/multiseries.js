                        ...
                        if(indicator_code[k]==first_row[ind])
                           {
                             ...
                             {
                                mapBirth[first_row[4]] = parseFloat(mapBirth[first_row[4]]) + parseFloat(first_row[5]);

                             }
                             else
                             {
                               mapDeath[first_row[4]] = parseFloat(mapDeath[first_row[4]]) + parseFloat(first_row[5]);
...
rl.on('close',function () {
 ...
 file.writeFile('jsonmultiseries.json',JSON.stringify(final),'utf-8');
 console.log("done");
})
